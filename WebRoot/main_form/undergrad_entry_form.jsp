        ...
        <td>
            ...
            <%
                ...
                if (action != null && action.equals("insert")) {
                    ...
                    pstmt = conn
                    .prepareStatement("INSERT INTO undergrad (first_name, middle_name, last_name, citizen, ssn, pre_school, pre_degree, pre_major, col_id, major, minor, is_bms) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                    ...
                    pstmt.setInt(9, Integer.parseInt(request.getParameter("col_id")));
                    pstmt.setString(10, request.getParameter("major"));
                    pstmt.setString(11, request.getParameter("minor"));
                    pstmt.setInt(12, Integer.parseInt(request.getParameter("is_bms")));
            ...
            <%
                ...
                if (action != null && action.equals("update")) {
                    ...
                    pstmt = conn
                        .prepareStatement("UPDATE undergrad SET first_name = ?, middle_name = ?, last_name = ?, citizen = ?, ssn = ?, pre_school = ?, pre_degree = ?, pre_major = ?, col_id = ?, major = ?, minor = ?, is_bms = ? WHERE stu_id = ? ");
                    ...
                    pstmt.setString(11, request.getParameter("minor"));
                    pstmt.setInt(12, Integer.parseInt(request.getParameter("is_bms")));
                    pstmt.setInt(13, Integer.parseInt(request.getParameter("stu_id")));
            ...
            <%
                ...
                if (action != null && action.equals("delete")) {
                    ...
                    pstmt = conn
                        .prepareStatement("DELETE FROM undergrad WHERE stu_id = ?");
