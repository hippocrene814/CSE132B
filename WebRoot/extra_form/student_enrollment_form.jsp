        ...
        <td>
            ...
            <%
                ...
                if (action != null && action.equals("insert")) {
                    ...
                    pstmt = conn.prepareStatement("INSERT INTO student_enrollment (stu_id, year, quarter) VALUES (?, ?, ?)");
            ...
            <%
                ...
                if (action != null && action.equals("update")) {
                    ...
                    pstmt = conn
                        .prepareStatement("UPDATE student_enrollment SET stu_id = ?, year = ?, quarter = ? WHERE se_id = ? ");

                    pstmt.setInt(1, Integer.parseInt(request.getParameter("stu_id")));
                    pstmt.setInt(2, Integer.parseInt(request.getParameter("year")));
                    pstmt.setString(3, request.getParameter("quarter"));
                    pstmt.setInt(4, Integer.parseInt(request.getParameter("se_id")));
                    int rowCount = pstmt.executeUpdate();
            ...
            <%
                ...
                if (action != null && action.equals("delete")) {
                    ...
                    pstmt = conn
                        .prepareStatement("DELETE FROM student_enrollment WHERE se_id = ?");

                    pstmt.setInt(1, Integer.parseInt(request.getParameter("se_id")));
                    int rowCount = pstmt.executeUpdate();
            ...
            <%
                ...
                rs = statement.executeQuery("SELECT * FROM student_enrollment ORDER BY se_id");
            %>
            ...
            <tr>
                <form action="student_enrollment_form.jsp" method="POST">
