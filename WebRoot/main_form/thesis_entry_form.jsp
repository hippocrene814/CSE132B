        ...
        <td>
            ...
            <%
                ...
                if (action != null && action.equals("insert")) {
                    ...
                    pstmt = conn
                    .prepareStatement("INSERT INTO thesis (stu_id, fac_id) VALUES (?, ?)");
            ...
            <%
                ...
                if (action != null && action.equals("update")) {
                    ...
                    pstmt = conn
                        .prepareStatement("UPDATE thesis SET stu_id = ?, fac_id = ? WHERE th_id = ? ");
            ...
            <%
                ...
                if (action != null && action.equals("delete")) {
                    ...
                    pstmt = conn
                        .prepareStatement("DELETE FROM thesis WHERE th_id = ?");

                    pstmt.setInt(1, Integer.parseInt(request.getParameter("th_id")));
                    int rowCount = pstmt.executeUpdate();
            ...
            <%
                ...
                rs = statement.executeQuery("SELECT * FROM thesis ORDER BY th_id");
            %>
            ...
            <tr>
                <form action="thesis_entry_form.jsp" method="POST">
                    ...
                    <input type="hidden" name="th_id" value="<%=rs.getInt("th_id")%>"/>
