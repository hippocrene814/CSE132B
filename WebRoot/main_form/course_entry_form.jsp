        ...
        <td>
            ...
            <%
                ...
                if (action != null && action.equals("insert")) {
                    ...
                    pstmt = conn
                    .prepareStatement("INSERT INTO course (course_number, min_unit, max_unit, grade_option, need_lab, need_consent, cate_id) VALUES (?, ?, ?, ?, ?, ?, ?)");
            ...
            <%
                ...
                if (action != null && action.equals("update")) {
                    ...
                    pstmt = conn
                        .prepareStatement("UPDATE course SET course_number = ?, min_unit = ?, max_unit = ?, grade_option = ?, need_lab = ?, need_consent = ?, cate_id = ? WHERE course_id = ? ");
